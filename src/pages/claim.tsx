...
export default function Claims({ account, claim }: { account: Account, claim: string[] }) {
    ...
    return <Layout title = "Claim your prizes" canonical = "/claim" description = {"Enter your shipping information to claim your prize"}>
        ...
        {claim.length == 0 &&
            <form onSubmit = {formik.handleSubmit} className = "flex flex-col gap-2 max-w-prose mx-auto">
...
export async function getServerSideProps(context): Promise<GetServerSidePropsResult<{ account: Account, claim: string[] }>> {
